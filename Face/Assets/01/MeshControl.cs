                ...
                if (go != null)
                {
                    ...
                    switch (modify.type)
                    {
                        ...
                        case ModifyType.Z:
                            ...
                            break;
                        case ModifyType.rotateX:
                            trans.Rotate(new Vector3(value, 0, 0), Space.Self);
                            break;
                        case ModifyType.rotateY:
                            trans.Rotate(new Vector3(0, value, 0), Space.Self);
                            break;
                        case ModifyType.rotateZ:
                            trans.Rotate(new Vector3(0, 0, value), Space.Self);
                            break;
                    }
                }
            }
